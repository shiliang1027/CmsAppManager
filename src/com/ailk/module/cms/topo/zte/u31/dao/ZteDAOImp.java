...
package com.ailk.module.cms.topo.zte.u31.dao;
 ...
 */
public class ZteDAOImp extends JPABaseDAO
{

	/**
	 * sql前缀
	 */
	private final String sqlPre = ZteDAOImp.class.getName();
	...
	public void batchSaveSystemInfo(List<Map> param)
	{
		...
		{
			System.out.println("批量插入报错:" + e.getMessage());
			for (Map map : param)
			{
	...
	public void batchSaveTranSystemInfo(List<Map> param)
	{
		...
		catch (Exception e)
		{
			...
			for (Map map : param)
			{
				...
				{
					System.out.println("批量插入报错:" + ex.getMessage());
				}
			}
		}
	}
